...
# ------------------------------------ TODO ----------------------------------------
# ----------------------------------------------------------------------------------
#  * need to wrap query.r and dbi-s3.r relevant .DBIConnection methods as .Pool methods
#    Otherwise we'll keep geeting errors. E.g.:
#
#    library(RPostgres)
#    library(DBI)
#    library(pool)
...
#      )
#
#   data <- src_pool(pool) %>% tbl("city") %>% collect()
#   ## Error in UseMethod("db_query_fields") :
#     no applicable method for 'db_query_fields' applied to an object of class "c('Pool', 'R6')"
#
